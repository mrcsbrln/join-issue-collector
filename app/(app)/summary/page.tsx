...
function UrgentCircleIcon() {
  return (
    <div className="size-[60px] rounded-full bg-priority-urgent flex items-center justify-center shrink-0">
...
function StatCard({
  ...
  return (
    <Link
      href={href}
      className={`${cardBase} flex items-center gap-[18px] h-[168px] flex-1 justify-center`}
    >
      {icon}
...
function UrgencyCard({
  ...
  return (
    <Link
      href="/board"
      className={`${cardBase} flex items-center justify-center gap-[61px] h-[168px] px-12`}
    >
...
export default async function SummaryPage() {
  ...
  return (
    <div className="pl-14 pt-[70px]">
      <div className="flex items-center gap-[30px] mb-[59px]">
        <h1 className="text-[61px] font-bold leading-[1.2] text-black whitespace-nowrap">
          Join 360
        </h1>
        <div className="w-px h-[59px] bg-border shrink-0" />
        <p className="text-[27px] font-normal text-navy whitespace-nowrap">
          Key Metrics at a Glance
        </p>
      </div>

      <div className="flex gap-20 items-center">
        <div className="flex flex-col gap-7 w-[560px] shrink-0">
