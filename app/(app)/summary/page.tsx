...
function EmailRequestsCard({ count }: { count: number }) {
  return (
    <Link
      href="/board"
      className={`${cardBase} flex flex-col items-center justify-center shrink-0 w-[110px] lg:w-[168px]`}
    >
...
function UrgencyCard({
  ...
  return (
    <Link
      href="/board"
      className={`${cardBase} flex-1 flex items-center justify-center gap-[24px] lg:gap-[61px] min-h-[110px] lg:min-h-[168px] px-4 lg:px-12`}
    >
    ...
    <div className="lg:pl-14 lg:pt-[70px]">
      ...
      <div className="flex flex-col xl:flex-row xl:gap-20 xl:items-center">
        <div className="flex flex-col items-stretch gap-4 lg:gap-7 w-full lg:max-w-[560px] xl:max-w-none xl:w-[560px] xl:shrink-0">
          ...
          <div className="flex items-stretch gap-6 lg:gap-7">
