    ...
    <>
      ...
      >
        <div className="flex min-h-full items-start lg:items-center justify-center p-2 lg:p-8">
          ...
          >
            <div className="px-5 py-6 lg:px-[40px] lg:py-[48px]">
              {isEditing ? (
                <>
                  <div className="flex items-center justify-between mb-6 lg:mb-10">
                    <h2 className="text-[24px] lg:text-[61px] font-bold leading-[1.2] text-black">
                      Edit Task
                    </h2>
                    <button
                      type="button"
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {/* Title */}
                  <h2 className="text-[22px] lg:text-[61px] font-bold leading-[1.2] text-black wrap-break-word">
                    {currentTask.title}
                  </h2>
