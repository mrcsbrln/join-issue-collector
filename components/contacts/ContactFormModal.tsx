  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-8 overflow-y-auto">
        <div className="bg-white rounded-[30px] shadow-[0_0_4px_rgba(0,0,0,0.1)] w-full max-w-[600px] relative px-4 py-8 lg:px-[74px] lg:py-16">
          <button
            type="button"
            onClick={onClose}
          ...
          <h1 className="text-[47px] lg:text-[61px] font-bold leading-[1.2] text-black mb-8 lg:mb-10">
